...
def task_done_pick_place(
    ...
    object_x = object.data.root_pos_w.torch[:, 0] - env.scene.env_origins[:, 0]
    object_y = object.data.root_pos_w.torch[:, 1] - env.scene.env_origins[:, 1]
...
def task_done_nut_pour(
    ...
    scale_pos = sorting_scale.data.root_pos_w.torch - env.scene.env_origins
    bowl_pos = sorting_bowl.data.root_pos_w.torch - env.scene.env_origins
    sorting_beaker_pos = sorting_beaker.data.root_pos_w.torch - env.scene.env_origins
    nut_pos = factory_nut.data.root_pos_w.torch - env.scene.env_origins
    bin_pos = sorting_bin.data.root_pos_w.torch - env.scene.env_origins
...
def task_done_exhaust_pipe(
    ...
    # Get positions relative to environment origin
    blue_exhaust_pipe_pos = blue_exhaust_pipe.data.root_pos_w.torch - env.scene.env_origins
    blue_sorting_bin_pos = blue_sorting_bin.data.root_pos_w.torch - env.scene.env_origins
